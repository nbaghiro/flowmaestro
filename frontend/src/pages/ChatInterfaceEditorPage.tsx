        ...
        <div className="min-h-screen bg-background">
                ...
                <div className="bg-card border-2 border-border rounded-2xl overflow-hidden shadow-sm">
                    ...
                    <div className="p-6 pt-12">
                        ...
                        <textarea
                            ...
                            onChange={(e) =>
                                updateChatInterface({ description: e.target.value || undefined })
                            }
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <textarea
                                        ...
                                        onChange={(e) =>
                                            updateChatInterface({ welcomeMessage: e.target.value })
                                        }
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    {chatInterface.suggestedPrompts.map(
                                        (prompt: ChatInterfaceSuggestedPrompt, index: number) => (
                                            <div
                                                key={index}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2 items-center">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            updateChatInterface({ placeholderText: e.target.value })
                                        }
            ...
            >
                <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <FormField label="Persistence Type">
                                <Select
                                    ...
                                    onChange={(value) =>
                                        updateChatInterface({
                                            persistenceType: value as "session" | "local_storage"
                                        })
                                    }
                                >
                        ...
                        <div className="space-y-4">
                            <FormField label="Widget Position">
                                <Select
                                    ...
                                    onChange={(value) =>
                                        updateChatInterface({
                                            widgetPosition: value as "bottom-right" | "bottom-left"
                                        })
                                    }
                                >
                            ...
                            <FormField label="Initial State">
                                <Select
                                    ...
                                    onChange={(value) =>
                                        updateChatInterface({
                                            widgetInitialState: value as "collapsed" | "expanded"
                                        })
                                    }
                                >
                                    <SelectItem value="collapsed">Collapsed (bubble)</SelectItem>
                    ...
                    <div>
                        <h4 className="text-sm font-medium text-foreground mb-3">File Uploads</h4>
                    ...
                    {/* Rate Limiting */}
                    <div>
                        <h4 className="text-sm font-medium text-foreground mb-3">Rate Limiting</h4>
                        <div className="space-y-4">
                            ...
                            <FormField label="Window (seconds)">
                                <Input
                                    ...
                                    onChange={(e) =>
                                        updateChatInterface({
                                            rateLimitWindowSeconds: parseInt(e.target.value) || 60
                                        })
                                    }
                                    min={10}
                                    max={3600}
                        ...
                        <FormField label="URL Slug">
                            <div className="flex items-center gap-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => updateChatInterface({ slug: e.target.value })}
                                    placeholder="my-chat"
                                    className="flex-1"
                                />
                            </div>
