/**
 * Pandadoc Provider Unit Tests
 *
 * Tests the PandaDocProvider class in isolation.
...
describe("PandaDocProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("pandadoc");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "pandadoc".replace(/-/g, "_") + "_";
