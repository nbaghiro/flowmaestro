/**
 * Squarespace Provider Unit Tests
 *
 * Tests the SquarespaceProvider class in isolation.
...
describe("SquarespaceProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("squarespace");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "squarespace".replace(/-/g, "_") + "_";
