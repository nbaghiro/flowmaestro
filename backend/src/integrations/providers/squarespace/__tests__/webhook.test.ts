/**
 * Squarespace Webhook Verification Tests
 *
 * Tests squarespace-specific webhook signature verification and event extraction.
 */

import { SquarespaceProvider } from "../SquarespaceProvider";
// TODO: Import webhook test utilities when implementing detailed tests
// import { createSquarespaceWebhookData, createSquarespaceEventPayload } from "../../../../../__tests__/helpers/webhook-test-utils";

describe("Squarespace Webhook Verification", () => {
    let provider: SquarespaceProvider;
    const secret = "test_webhook_secret_12345";

    beforeEach(() => {
        provider = new SquarespaceProvider();
    });
