/**
 * Bigquery Provider Unit Tests
 *
 * Tests the BigQueryProvider class in isolation.
...
describe("BigQueryProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("bigquery");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "bigquery".replace(/-/g, "_") + "_";
