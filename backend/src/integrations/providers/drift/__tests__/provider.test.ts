/**
 * Drift Provider Unit Tests
 *
 * Tests the DriftProvider class in isolation.
...
describe("DriftProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("drift");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "drift".replace(/-/g, "_") + "_";
