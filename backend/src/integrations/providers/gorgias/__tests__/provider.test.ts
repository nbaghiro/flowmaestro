/**
 * Gorgias Provider Unit Tests
 *
 * Tests the GorgiasProvider class in isolation.
...
describe("GorgiasProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("gorgias");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "gorgias".replace(/-/g, "_") + "_";
