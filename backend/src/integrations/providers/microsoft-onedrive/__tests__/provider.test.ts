/**
 * MicrosoftOnedrive Provider Unit Tests
 *
 * Tests the MicrosoftOneDriveProvider class in isolation.
 * Validates operation registration, trigger setup, auth config, and webhook configuration.
 */

import { MicrosoftOneDriveProvider } from "../MicrosoftOneDriveProvider";
import type { OAuthConfig, WebhookConfig } from "../../../core/types";

describe("MicrosoftOneDriveProvider", () => {
    let provider: MicrosoftOneDriveProvider;
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "microsoft-onedrive".replace(/-/g, "_") + "_";
