/**
 * ZohoCrm Provider Unit Tests
 *
 * Tests the ZohoCrmProvider class in isolation.
...
describe("ZohoCrmProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("zoho-crm");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "zoho-crm".replace(/-/g, "_") + "_";
