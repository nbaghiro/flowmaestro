 ...
 *
 * Converts Zoho CRM operations into MCP tools for AI agents
 */
export class ZohoCrmMCPAdapter {
    ...
    async executeTool(
        ...
        _client: ZohoCrmClient
    ): Promise<unknown> {
        // Remove "zoho_crm_" prefix to get operation ID
        const operationId = toolName.replace("zoho_crm_", "");
