/**
 * GoogleCloudStorage Provider Unit Tests
 *
 * Tests the GoogleCloudStorageProvider class in isolation.
...
describe("GoogleCloudStorageProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("google-cloud-storage");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "google-cloud-storage".replace(/-/g, "_") + "_";
