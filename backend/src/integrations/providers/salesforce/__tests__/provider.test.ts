/**
 * Salesforce Provider Unit Tests
 *
 * Tests the SalesforceProvider class in isolation.
...
describe("SalesforceProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("salesforce");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "salesforce".replace(/-/g, "_") + "_";
