/**
 * GoogleForms Provider Unit Tests
 *
 * Tests the GoogleFormsProvider class in isolation.
...
describe("GoogleFormsProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("google-forms");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "google-forms".replace(/-/g, "_") + "_";
