/**
 * Shipstation Provider Unit Tests
 *
 * Tests the ShipStationProvider class in isolation.
...
describe("ShipStationProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("shipstation");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "shipstation".replace(/-/g, "_") + "_";
