/**
 * Monday Webhook Verification Tests
 *
 * Tests monday-specific webhook signature verification and event extraction.
 */

import { MondayProvider } from "../MondayProvider";
// TODO: Import webhook test utilities when implementing detailed tests
// import { createMondayWebhookData, createMondayEventPayload } from "../../../../../__tests__/helpers/webhook-test-utils";

describe("Monday Webhook Verification", () => {
    let provider: MondayProvider;
    const secret = "test_webhook_secret_12345";

    beforeEach(() => {
        provider = new MondayProvider();
    });
