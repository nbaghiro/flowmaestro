/**
 * Deel Provider Unit Tests
 *
 * Tests the DeelProvider class in isolation.
...
describe("DeelProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("deel");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "deel".replace(/-/g, "_") + "_";
