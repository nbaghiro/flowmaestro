/**
 * Bigcommerce Provider Unit Tests
 *
 * Tests the BigCommerceProvider class in isolation.
...
describe("BigCommerceProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("bigcommerce");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "bigcommerce".replace(/-/g, "_") + "_";
