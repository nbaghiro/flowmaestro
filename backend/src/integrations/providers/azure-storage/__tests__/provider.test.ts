/**
 * AzureStorage Provider Unit Tests
 *
 * Tests the AzureStorageProvider class in isolation.
...
describe("AzureStorageProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("azure-storage");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "azure-storage".replace(/-/g, "_") + "_";
