 ...
 *
 * Converts Close operations into MCP tools for AI agents
 */
export class CloseMCPAdapter {
    ...
    async executeTool(
        ...
        // Remove "close_" prefix to get operation ID
        const operationId = toolName.replace("close_", "");
