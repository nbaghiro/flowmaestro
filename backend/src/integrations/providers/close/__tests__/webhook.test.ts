/**
 * Close Webhook Verification Tests
 *
 * Tests close-specific webhook signature verification and event extraction.
 */

import { CloseProvider } from "../CloseProvider";
// TODO: Import webhook test utilities when implementing detailed tests
// import { createCloseWebhookData, createCloseEventPayload } from "../../../../../__tests__/helpers/webhook-test-utils";

describe("Close Webhook Verification", () => {
    let provider: CloseProvider;
    const secret = "test_webhook_secret_12345";

    beforeEach(() => {
        provider = new CloseProvider();
    });
