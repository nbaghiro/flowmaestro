/**
 * Lattice Provider Unit Tests
 *
 * Tests the LatticeProvider class in isolation.
...
describe("LatticeProvider", () => {
    ...
    beforeEach(() => {
        provider = new LatticeProvider();
    });

    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("lattice");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "lattice".replace(/-/g, "_") + "_";
