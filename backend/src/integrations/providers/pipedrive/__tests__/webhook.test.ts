/**
 * Pipedrive Webhook Verification Tests
 *
 * Tests pipedrive-specific webhook signature verification and event extraction.
 */

import { PipedriveProvider } from "../PipedriveProvider";
// TODO: Import webhook test utilities when implementing detailed tests
// import { createPipedriveWebhookData, createPipedriveEventPayload } from "../../../../../__tests__/helpers/webhook-test-utils";

describe("Pipedrive Webhook Verification", () => {
    let provider: PipedriveProvider;
