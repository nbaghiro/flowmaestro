/**
 * Pipedrive Provider Unit Tests
 *
 * Tests the PipedriveProvider class in isolation.
...
describe("PipedriveProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("pipedrive");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "pipedrive".replace(/-/g, "_") + "_";
