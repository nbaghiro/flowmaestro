/**
 * Medium Provider Unit Tests
 *
 * Tests the MediumProvider class in isolation.
...
describe("MediumProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("medium");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "medium".replace(/-/g, "_") + "_";
