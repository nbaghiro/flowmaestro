/**
 * GoogleMeet Provider Unit Tests
 *
 * Tests the GoogleMeetProvider class in isolation.
...
describe("GoogleMeetProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("google-meet");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "google-meet".replace(/-/g, "_") + "_";
