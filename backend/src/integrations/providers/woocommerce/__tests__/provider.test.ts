/**
 * Woocommerce Provider Unit Tests
 *
 * Tests the WooCommerceProvider class in isolation.
...
describe("WooCommerceProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("woocommerce");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "woocommerce".replace(/-/g, "_") + "_";
