/**
 * Kustomer Provider Unit Tests
 *
 * Tests the KustomerProvider class in isolation.
...
describe("KustomerProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("kustomer");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "kustomer".replace(/-/g, "_") + "_";
