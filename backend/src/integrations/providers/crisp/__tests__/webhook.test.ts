/**
 * Crisp Webhook Verification Tests
 *
 * Tests crisp-specific webhook signature verification and event extraction.
 */

import { CrispProvider } from "../CrispProvider";
// TODO: Import webhook test utilities when implementing detailed tests
// import { createCrispWebhookData, createCrispEventPayload } from "../../../../../__tests__/helpers/webhook-test-utils";

describe("Crisp Webhook Verification", () => {
    let provider: CrispProvider;
    const secret = "test_webhook_secret_12345";

    beforeEach(() => {
        provider = new CrispProvider();
    });
