/**
 * Twitter Provider Test Fixtures
 */
...
export const twitterFixtures: TestFixture[] = [
    {
        ...
        validCases: [
            {
                name: "basic_deleteTweet",
                description:
                    "Delete a tweet by its ID. Only the author can delete their own tweets.",
                input: {
    ...
    },
    {
        ...
        validCases: [
            {
                name: "basic_getUserTimeline",
                description: "Get recent tweets from a user. Returns the authenticated user",
                input: {
                    // TODO: Add input parameters based on operation schema
                },
                expectedOutput: {
    ...
    },
    {
        ...
        validCases: [
            {
                name: "basic_postTweet",
                description:
                    "Create a new tweet on X. Can optionally reply to or quote another tweet.",
                input: {
                    // TODO: Add input parameters based on operation schema
                },
                expectedOutput: {
