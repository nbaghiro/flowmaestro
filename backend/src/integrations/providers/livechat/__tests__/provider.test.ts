/**
 * Livechat Provider Unit Tests
 *
 * Tests the LiveChatProvider class in isolation.
...
describe("LiveChatProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("livechat");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "livechat".replace(/-/g, "_") + "_";
