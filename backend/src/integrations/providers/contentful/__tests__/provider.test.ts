/**
 * Contentful Provider Unit Tests
 *
 * Tests the ContentfulProvider class in isolation.
...
describe("ContentfulProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("contentful");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "contentful".replace(/-/g, "_") + "_";
