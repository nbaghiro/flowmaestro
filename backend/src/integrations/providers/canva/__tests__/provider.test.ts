...
describe("CanvaProvider", () => {
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "canva".replace(/-/g, "_") + "_";
