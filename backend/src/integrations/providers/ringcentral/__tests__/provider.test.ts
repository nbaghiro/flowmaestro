/**
 * Ringcentral Provider Unit Tests
 *
 * Tests the RingCentralProvider class in isolation.
...
describe("RingCentralProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("ringcentral");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "ringcentral".replace(/-/g, "_") + "_";
