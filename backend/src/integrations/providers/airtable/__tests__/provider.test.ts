/**
 * Airtable Provider Unit Tests
 *
 * Tests the AirtableProvider class in isolation.
...
describe("AirtableProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("airtable");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "airtable".replace(/-/g, "_") + "_";
