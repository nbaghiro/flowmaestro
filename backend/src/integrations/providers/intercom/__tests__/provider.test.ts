/**
 * Intercom Provider Unit Tests
 *
 * Tests the IntercomProvider class in isolation.
...
describe("IntercomProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("intercom");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "intercom".replace(/-/g, "_") + "_";
