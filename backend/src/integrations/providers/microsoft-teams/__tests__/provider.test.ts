/**
 * MicrosoftTeams Provider Unit Tests
 *
 * Tests the MicrosoftTeamsProvider class in isolation.
...
describe("MicrosoftTeamsProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("microsoft-teams");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "microsoft-teams".replace(/-/g, "_") + "_";
