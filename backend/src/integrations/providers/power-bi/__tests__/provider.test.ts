/**
 * PowerBi Provider Unit Tests
 *
 * Tests the PowerBIProvider class in isolation.
...
describe("PowerBIProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("power-bi");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "power-bi".replace(/-/g, "_") + "_";
