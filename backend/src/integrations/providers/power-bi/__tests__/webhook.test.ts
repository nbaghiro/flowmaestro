/**
 * PowerBi Webhook Verification Tests
 *
 * Tests power-bi-specific webhook signature verification and event extraction.
 */

import { PowerBIProvider } from "../PowerBIProvider";
// TODO: Import webhook test utilities when implementing detailed tests
// import { createPowerBiWebhookData, createPowerBiEventPayload } from "../../../../../__tests__/helpers/webhook-test-utils";

describe("PowerBi Webhook Verification", () => {
    let provider: PowerBIProvider;
    const secret = "test_webhook_secret_12345";

    beforeEach(() => {
        provider = new PowerBIProvider();
    });
