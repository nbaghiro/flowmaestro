/**
 * Heap Provider Unit Tests
 *
 * Tests the HeapProvider class in isolation.
...
describe("HeapProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("heap");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "heap".replace(/-/g, "_") + "_";
