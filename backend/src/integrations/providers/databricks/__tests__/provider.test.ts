/**
 * Databricks Provider Unit Tests
 *
 * Tests the DatabricksProvider class in isolation.
...
describe("DatabricksProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("databricks");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "databricks".replace(/-/g, "_") + "_";
