/**
 * Freshdesk Provider Unit Tests
 *
 * Tests the FreshdeskProvider class in isolation.
...
describe("FreshdeskProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("freshdesk");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "freshdesk".replace(/-/g, "_") + "_";
