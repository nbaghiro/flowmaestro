 ...
 *
 * Tests github-specific webhook signature verification and event extraction.
 */

import { GitHubProvider } from "../GitHubProvider";
// TODO: Import webhook test utilities when implementing detailed tests
// import { createGithubWebhookData, createGithubEventPayload } from "../../../../../__tests__/helpers/webhook-test-utils";
