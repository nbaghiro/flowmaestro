/**
 * Helpscout Provider Unit Tests
 *
 * Tests the HelpScoutProvider class in isolation.
...
describe("HelpScoutProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("helpscout");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "helpscout".replace(/-/g, "_") + "_";
