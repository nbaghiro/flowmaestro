/**
 * Calendly Provider Unit Tests
 *
 * Tests the CalendlyProvider class in isolation.
...
describe("CalendlyProvider", () => {
    ...
    describe("provider metadata", () => {
        it("has correct name and display name", () => {
            expect(provider.name).toBe("calendly");
    ...
    describe("MCP tools", () => {
        ...
        it("follows naming convention", () => {
            const tools = provider.getMCPTools();
            const expectedPrefix = "calendly".replace(/-/g, "_") + "_";
