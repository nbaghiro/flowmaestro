...
import { blogAdminRoutes } from "./routes/blog-posts";
import { chatInterfaceRoutes } from "./routes/chat-interfaces";
import { checkpointRoutes } from "./routes/checkpoints";
import { clientLogRoutes } from "./routes/client-logs";
...
import { publicBlogRoutes } from "./routes/public/blog-posts";
...
export async function buildServer() {
    ...
    await fastify.register(clientLogRoutes);
