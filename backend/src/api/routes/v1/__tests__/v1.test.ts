...
describe("Public API v1 Routes", () => {
    ...
    describe("Agent Memory", () => {
        ...
        describe("GET /api/v1/agents/:agentId/memory/:userId", () => {
            ...
            it("should return 404 for non-existent agent", async () => {
                ...
                const response = await apiKeyRequest(fastify, {
                    method: "GET",
                    url: "/api/v1/agents/non-existent/memory/user-1"
                });
        ...
        describe("POST /api/v1/agents/:agentId/memory/search", () => {
            ...
            it("should return 404 for non-existent agent", async () => {
                ...
                const response = await apiKeyRequest(fastify, {
                    method: "POST",
                    url: "/api/v1/agents/non-existent/memory/search",
                    payload: { query: "test" }
                });
        ...
        describe("GET /api/v1/agents/:agentId/memory/stats", () => {
            ...
            it("should return 404 for non-existent agent", async () => {
                ...
                const response = await apiKeyRequest(fastify, {
                    method: "GET",
                    url: "/api/v1/agents/non-existent/memory/stats"
                });
            ...
            it("should handle embedding count errors gracefully", async () => {
                ...
                // Should still return 200 with embedding_count: 0
                expect(response.statusCode).toBe(200);
                const body = parseResponse(response);
    ...
    describe("Error handling", () => {
        it("should return 500 when workflow repository throws on list", async () => {
        ...
        it("should return 500 when execution repository throws on list", async () => {
            mockWorkflowRepo.findByWorkspaceId.mockResolvedValue({
                workflows: [{ id: "wf-1" }]
            });
            mockExecutionRepo.findAll.mockRejectedValue(new Error("Database error"));
        ...
        it("should return 500 when agent repository throws on list", async () => {
            mockAgentRepo.findByWorkspaceId.mockRejectedValue(new Error("Database error"));
