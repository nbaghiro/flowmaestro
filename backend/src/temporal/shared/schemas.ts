/**
 * Zod schemas for executor configuration validation
 * Provides runtime validation, type inference, and helpful error messages
 */
...
// ============================================================================
// Schema Registry - Maps node types to their schemas
// ============================================================================
 ...
 */
export function validateNodeConfig(nodeType: string, config: unknown): ValidationResult<unknown> {
