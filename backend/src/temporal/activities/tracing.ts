/**
 * Tracing - OpenTelemetry span management for workflow execution
 *
 * Consolidated tracing functionality including:
 * - Span types (workflow-safe enum for sandboxed environments)
 * - Base tracing functions for span creation and management
 * - Orchestration span activities for workflows, nodes, agents, and LLM operations
 *
 * Note: SpanType enum is workflow-safe and can be imported in sandboxed environments.
 */
...
// ============================================================================
// SPAN TYPES (re-exported from canonical source)
// ============================================================================

// Import and re-export SpanType from core/types.ts - the canonical definition
// Workflows import from core/workflow-safe.ts which gets it from core/types.ts
// Activities import from here for convenience
...
// ============================================================================
// ORCHESTRATION SPAN ACTIVITIES
// ============================================================================

// ----------------------------------------
// Agent Tracing Activities
// ----------------------------------------
