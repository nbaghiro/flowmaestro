...
jest.mock("../../../src/storage/repositories/UserRepository", () => ({
    UserRepository: jest.fn().mockImplementation(() => mockUserRepo)
}));

jest.mock("../../../src/storage/repositories/EmailVerificationTokenRepository", () => ({
    EmailVerificationTokenRepository: jest
        .fn()
        .mockImplementation(() => mockEmailVerificationTokenRepo)
}));

jest.mock("../../../src/storage/repositories/PasswordResetTokenRepository", () => ({
    PasswordResetTokenRepository: jest.fn().mockImplementation(() => mockPasswordResetTokenRepo)
}));

jest.mock("../../../src/storage/repositories/TwoFactorTokenRepository", () => ({
    TwoFactorTokenRepository: jest.fn().mockImplementation(() => mockTwoFactorTokenRepo)
}));

jest.mock("../../../src/storage/repositories/TwoFactorBackupCodeRepository", () => ({
    TwoFactorBackupCodeRepository: jest.fn().mockImplementation(() => mockTwoFactorBackupCodeRepo)
}));

// Mock password utilities
jest.mock("../../../src/core/utils/password", () => ({
    PasswordUtils: {
...
jest.mock("../../../src/core/utils/token", () => ({
    TokenUtils: {
...
jest.mock("../../../src/core/utils/two-factor", () => ({
...
import { hashCode } from "../../../src/core/utils/two-factor";
import {
