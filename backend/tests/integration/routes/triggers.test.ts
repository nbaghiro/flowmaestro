...
jest.mock("../../../src/storage/repositories/TriggerRepository", () => ({
...
jest.mock("../../../src/storage/repositories/ExecutionRepository", () => ({
...
jest.mock("../../../src/temporal/core/services/scheduler", () => ({
...
jest.mock("../../../src/temporal/core/services/webhook", () => ({
...
jest.mock("../../../src/core/utils/workflow-converter", () => ({
