...
jest.mock("../../../src/storage/repositories/WorkflowRepository");
jest.mock("../../../src/storage/repositories/ConnectionRepository");
jest.mock("../../../src/storage/repositories/SafetyLogRepository");
jest.mock("../../../src/core/safety/safety-pipeline");
jest.mock("../../../src/core/validation/tool-validation");
...
jest.mock("../../../src/temporal/activities/agents/events", () => ({
    emitAgentToken: jest.fn()
}));
jest.mock("../../../src/temporal/activities/agents/memory", () => ({
...
import { SafetyPipeline } from "../../../src/core/safety/safety-pipeline";
import {
    validateToolInput,
    coerceToolArguments,
    createValidationErrorResponse
} from "../../../src/core/validation/tool-validation";
import { SafetyLogRepository } from "../../../src/storage/repositories/SafetyLogRepository";
import {
    getAgentConfig,
    executeToolCall,
    validateInput,
    ...
    isAgentTool,
    getAgentIdFromTool
} from "../../../src/temporal/activities/agents/core";

import type { Tool } from "../../../src/storage/models/Agent";
import type { ToolCall } from "../../../src/storage/models/AgentExecution";
