...
describe("DeepgramStreamClient", () => {
    let DeepgramStreamClient: typeof import("../DeepgramStreamClient").DeepgramStreamClient;
    let client: import("../DeepgramStreamClient").DeepgramStreamClient;
    ...
    beforeEach(async () => {
        ...
        const module = await import("../DeepgramStreamClient");
