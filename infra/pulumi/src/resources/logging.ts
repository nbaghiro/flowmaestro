...
/**
 * Application logs bucket with configurable retention
 */
export const applicationLogBucket = new gcp.logging.ProjectBucketConfig(
    resourceName("app-logs-bucket"),
    {
        ...
        retentionDays: infrastructureConfig.appLogRetentionDays,
        description: `FlowMaestro application logs with ${infrastructureConfig.appLogRetentionDays}-day retention`
    }
);

/**
 * Error logs bucket with configurable retention
 */
export const errorLogBucket = new gcp.logging.ProjectBucketConfig(
    resourceName("error-logs-bucket"),
    {
        ...
        retentionDays: infrastructureConfig.errorLogRetentionDays,
        description: `FlowMaestro error logs with ${infrastructureConfig.errorLogRetentionDays}-day retention for debugging`
    }
);
 ...
 */
export const debugLogExclusion = new gcp.logging.ProjectExclusion(resourceName("debug-exclusion"), {
 ...
 */
export const errorLogMetric = new gcp.logging.Metric(resourceName("error-count-metric"), {
 ...
 */
export const workflowErrorMetric = new gcp.logging.Metric(resourceName("workflow-error-metric"), {
 ...
 */
export const frontendErrorMetric = new gcp.logging.Metric(resourceName("frontend-error-metric"), {
