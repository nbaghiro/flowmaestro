...
import { appSecretsOutputs } from "./app-secrets";
import {
    databaseOutputs,
...
import { esoOutputs } from "./external-secrets-operator";
import { githubActionsOutputs } from "./github-actions";
import { clusterOutputs } from "./gke-cluster";
import { apiOutputs } from "./google-apis";
...
4. Create Kubernetes secrets:
   ...
   # Redis runs in-cluster (infra/k8s/base/redis-deployment.yaml); the api and worker
   # read REDIS_HOST=redis and REDIS_PORT=6379 from their manifests.
...
Redis:
  In-cluster Service redis:6379 (Memorystore removed 2026-09-21)
