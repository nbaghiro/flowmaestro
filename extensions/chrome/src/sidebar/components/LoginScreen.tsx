...
export function LoginScreen() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-white p-6">
            ...
            <h1 className="text-xl font-semibold text-gray-900 mb-2">Welcome to FlowMaestro</h1>
            ...
            <div className="w-full max-w-xs space-y-3">
                <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
