                    ...
                    <div className="relative z-10 max-w-4xl mx-auto">
                        ...
                        >
                            ...
                            <div className="space-y-4 text-gray-300 leading-relaxed">
                                <p>
                                    FlowMaestro started in 2023 when our founders experienced
                                    firsthand the challenges of building reliable automation at
                                    scale. Traditional workflow tools were either too simple for
                                    complex use cases or required extensive engineering resources.
                                </p>
                                <p>
                                    We saw an opportunity to combine the reliability of durable
                                    execution (powered by Temporal) with the flexibility of AI
                                    agents, creating a platform where workflows and intelligent
